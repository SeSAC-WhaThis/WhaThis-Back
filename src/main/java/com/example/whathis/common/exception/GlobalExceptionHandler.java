...
public class GlobalExceptionHandler {
    ...
    private HttpStatus getHttpStatus(ErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case FORBIDDEN, ACCESS_DENIED, CANNOT_SELF_FOLLOW -> HttpStatus.FORBIDDEN;
            case NOT_FOUND, USER_NOT_FOUND, PRODUCT_NOT_FOUND, ORDER_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case ALREADY_EXISTS, DUPLICATE_EMAIL, DUPLICATE_NICKNAME, ALREADY_LIKED, ALREADY_FOLLOWING, NOT_FOLLOWING, OUT_OF_STOCK -> HttpStatus.CONFLICT;
            case FUNDING_NOT_ONGOING, FUNDING_ENDED, INVALID_ORDER_STATUS, CANNOT_CANCEL_ORDER -> HttpStatus.UNPROCESSABLE_ENTITY;
            case OAUTH_TOKEN_FAILED, OAUTH_USER_INFO_FAILED -> HttpStatus.BAD_GATEWAY;
